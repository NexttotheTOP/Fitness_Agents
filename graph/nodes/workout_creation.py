...
def create_workout_from_nlq(state: StateForWorkoutApp) -> Dict[str, Any]:
    ...
    try:
        ...
        [Plan Proposal]
        The following plan proposal was generated by our dedicated plan proposal agent, which analyzed the user's profile, assessment, body analysis, and direct request. Use this proposal as your main guide for structuring and rationalizing the workouts you create:
        ...
        [Instructions]
        - Use the plan proposal above as your primary blueprint for creating the detailed workouts.
        ...
        - Each workout should:
          ...
          7. Include appropriate exercises with proper comprehensiveform guidance
        ...
        {{
          ...
          "workouts": [
            {{
              "name": "Workout Name",
              "description": "Detailed description of the workout's purpose and benefits pointed directly towards the client",
              ...
              "exercises": [
                {{
                  ...
                  "notes": "Comprehensive form notes and guidance directly pointed towards client",
                  "details": {{
